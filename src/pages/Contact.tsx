...
import { CONTACT_PHONE_DISPLAY, getCallHref, getSmartWhatsAppHref } from "@/lib/contact";
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div className="reveal">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-lg font-semibold btn-shine hover:shadow-[0_0_40px_hsl(var(--primary)/0.35)] transition-all duration-300 w-full justify-center sm:w-auto"
                  >
              ...
              <div className="reveal reveal-delay-2">
                ...
                <div className="space-y-5 mb-10">
                  {[
                    { icon: Phone, label: "Phone", value: CONTACT_PHONE_DISPLAY, href: callHref },
                    { icon: Mail, label: "Email", value: "info@nilkanthdigital.com", href: "mailto:info@nilkanthdigital.com" },
                    { icon: MessageCircle, label: "WhatsApp", value: "Chat with us", href: whatsappHref, newTab: true },
                  ].map((item) => (
                    <a
                      key={item.label}
                      href={item.href}
                      ...
                      className="flex items-center gap-4 group p-4 rounded-lg border border-border bg-card hover-lift"
                    >
