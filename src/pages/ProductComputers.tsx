...
const products = [
  { name: "HP Slim CPU", desc: "Intel i3/i5, 4-8GB RAM, 256-512GB SSD, Windows 11", price: "₹8,000 – ₹20,000", badge: "Best Seller" },
  { name: "HP ProDesk Mini", desc: "Intel i5, 8GB RAM, 256GB SSD, Ultra Compact", price: "₹15,000 – ₹30,000" },
  { name: "Assemble PC — Basic", desc: "Intel i3, 8GB RAM, 256GB SSD, Cabinet + Monitor", price: "₹15,000 – ₹25,000" },
  { name: "Assemble PC — Business", desc: "Intel i5, 16GB RAM, 512GB SSD, Cabinet + 22\" Monitor", price: "₹25,000 – ₹45,000" },
  { name: "Assemble PC — Gaming", desc: "Intel i7/Ryzen 7, 16-32GB RAM, RTX GPU, RGB Case", price: "₹50,000 – ₹1,50,000" },
  { name: "Assemble PC — Workstation", desc: "Intel i9/Xeon, 32-64GB RAM, Professional GPU, ECC", price: "₹80,000 – ₹2,00,000" },
  { name: "All-in-One PC", desc: "HP/Lenovo AIO, i3-i5, 8GB RAM, 23.8\" FHD Display", price: "₹30,000 – ₹60,000" },
  { name: "Refurbished Desktop", desc: "Certified refurbished HP/Dell, i3/i5, 4-8GB RAM", price: "₹10,000 – ₹18,000" },
];
