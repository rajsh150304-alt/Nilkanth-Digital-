...
const products = [
  { name: "Audio Intercom System", desc: "2-wire audio intercom for homes & small offices", price: "₹5,000 – ₹8,000" },
  { name: "Video Door Phone", desc: "7\" color screen, night vision camera, 2-way audio", price: "₹8,000 – ₹15,000" },
  { name: "IP Video Intercom", desc: "WiFi enabled, mobile app support, HD camera", price: "₹12,000 – ₹20,000" },
  { name: "Multi-Apartment System", desc: "Building intercom for flats, multiple indoor units", price: "₹15,000 – ₹30,000" },
  { name: "Office Intercom PBX", desc: "Multi-line EPABX system for offices, 4-16 extensions", price: "₹10,000 – ₹25,000" },
  { name: "Wireless Intercom", desc: "No wiring needed, portable handsets, long range", price: "₹6,000 – ₹12,000" },
];
