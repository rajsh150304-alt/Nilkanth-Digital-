...
const products = [
  { name: "HP InkTank Printer", desc: "All-in-One Ink Tank, Print/Scan/Copy, WiFi, Low Cost Printing", price: "₹10,000 – ₹15,000", badge: "Popular" },
  { name: "HP LaserJet Printer", desc: "Mono Laser, Fast Printing, USB + WiFi, Auto Duplex", price: "₹12,000 – ₹20,000" },
  { name: "Canon PIXMA InkJet", desc: "Color InkJet, Print/Scan/Copy, Borderless Photo Print", price: "₹5,000 – ₹12,000" },
  { name: "Epson EcoTank Printer", desc: "High Yield Ink Tank, Ultra Low Cost, WiFi, All-in-One", price: "₹8,000 – ₹18,000" },
  { name: "Brother Laser Printer", desc: "Mono/Color Laser, Network Ready, High Volume", price: "₹10,000 – ₹25,000" },
  { name: "HP Color LaserJet", desc: "Color Laser, Professional Quality, Network, Duplex", price: "₹15,000 – ₹25,000" },
  { name: "Thermal Receipt Printer", desc: "POS Billing Printer, USB/Bluetooth, 80mm Width", price: "₹3,500 – ₹8,000" },
  { name: "Label Printer", desc: "Barcode & Label Printer, Thermal Transfer, USB", price: "₹5,000 – ₹15,000" },
];
