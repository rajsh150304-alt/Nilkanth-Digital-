...
const products = [
  { name: "HP Laptop 15s", desc: "Intel i3 12th Gen, 8GB RAM, 512GB SSD, 15.6\" FHD", price: "₹35,000 – ₹45,000", img: laptopImg1 },
  { name: "HP Laptop 14s", desc: "Intel i5 12th Gen, 8GB RAM, 512GB SSD, 14\" FHD", price: "₹45,000 – ₹55,000", img: laptopImg1 },
  { name: "Dell Inspiron 15", desc: "Intel i5/i7, 8-16GB RAM, 512GB SSD, 15.6\" FHD", price: "₹40,000 – ₹75,000", img: laptopImg1 },
  { name: "Lenovo IdeaPad Slim 3", desc: "AMD Ryzen 5, 8GB RAM, 512GB SSD, 15.6\" FHD", price: "₹35,000 – ₹50,000", img: laptopImg1 },
  { name: "Asus VivoBook 15", desc: "Intel i3/i5, 8GB RAM, 256-512GB SSD, 15.6\" FHD", price: "₹30,000 – ₹55,000", img: laptopImg1 },
  { name: "Acer Aspire 3", desc: "Intel i3/i5, 4-8GB RAM, 256-512GB SSD, 15.6\" HD", price: "₹25,000 – ₹45,000", img: laptopImg1 },
  { name: "HP Pavilion Gaming", desc: "Intel i5, 8-16GB RAM, GTX 1650, 512GB SSD", price: "₹55,000 – ₹80,000", img: laptopImg2 },
  { name: "Apple MacBook Air M1", desc: "M1 Chip, 8GB RAM, 256GB SSD, 13.3\" Retina", price: "₹75,000 – ₹1,00,000", img: laptopImg1 },
];
